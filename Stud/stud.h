...
EXPORT StudError CreateSession(const char* slotName, int nCtx, int nBatch, unsigned int flashAttn, int nThreads, int nThreadsBatch, float minP, float topP, int topK, float temp, float repeatPenalty, int kType, int vType);
...
EXPORT StudError DialecticInit(const char* slotName);
EXPORT StudError DialecticRelayInit(const char* slotName);
EXPORT StudError DialecticStart(const char* slotName);
EXPORT StudError DialecticSwap(const char* slotName);
EXPORT StudError DialecticRelaySwap(const char* slotName, const char* fromSlotName, const char* toSlotName);
EXPORT void DialecticFree(const char* slotName);
