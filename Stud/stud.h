...
EXPORT StudError LoadVisionProjector(const char* slotName, const char* filename, bool useGPU, int nThreads, unsigned int flashAttn);
...
EXPORT StudError SetMessageAtJson(const char* slotName, int index, const char* think, const char* contentJson);
...
EXPORT StudError AddMessageJson(const char* slotName, Stud::MessageRole role, const char* think, const char* contentJson);
...
EXPORT StudError GenerateWithToolsJson(const char* slotName, Stud::MessageRole role, const char* contentJson, int nPredict, bool callback);
...
EXPORT StudError GenerateForAPIJson(const char* slotName, Stud::MessageRole role, const char* contentJson, const char* toolsJson, int nPredict, bool callback, char** responseJson);
